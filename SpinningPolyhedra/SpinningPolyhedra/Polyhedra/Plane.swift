...
//
// A Plane is just a very thin cube.
...
final class Plane {
    ...
    let vertices: [SCNVector3] = [        // A cube has 8 vertices.
        SCNVector3( 0.5,  0.5,  0.01 ),           // vertex = 0
        SCNVector3( 0.5,  0.5, -0.01 ),           // vertex = 1
        SCNVector3( 0.5, -0.5,  0.01 ),           // vertex = 2
        SCNVector3( 0.5, -0.5, -0.01 ),           // vertex = 3
        SCNVector3(-0.5,  0.5,  0.01 ),           // vertex = 4
        SCNVector3(-0.5,  0.5, -0.01 ),           // vertex = 5
        SCNVector3(-0.5, -0.5,  0.01 ),           // vertex = 6
        SCNVector3(-0.5, -0.5, -0.01 )            // vertex = 7
    ]
